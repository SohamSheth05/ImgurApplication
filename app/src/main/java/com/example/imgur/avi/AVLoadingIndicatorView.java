...
import com.plus8.parcelpal.merchant.avi.indicators.BallPulseIndicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor = a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, getContext().getResources().getColor(R.color.colorPrimaryDark));
    ...
    public void setIndicator(String indicatorName) {
        ...
        try {
            ...
            //Debug.e("Didn't find your class , check the name again !"+e.getMessage());
